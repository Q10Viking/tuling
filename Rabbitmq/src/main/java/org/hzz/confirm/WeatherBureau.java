...
public class WeatherBureau {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        while (itr.hasNext()) {
            ...
            channel.basicPublish(RabbitConstant.EXCHANGE_WEATHER_ROUTING,me.getKey() ,true, null , me.getValue().getBytes());
        }
    }
}
/**
 ...
 交换机:weather_routing-路由key:china.hubei.wuhan.20201127
 Return主题：中国湖北武汉20201127天气数据
 ===========================
 ===========================
 Return编码：312-Return描述:NO_ROUTE
 交换机:weather_routing-路由key:china.hunan.zhuzhou.20201127
 Return主题：中国湖南株洲20201127天气数据
 ===========================
 ===========================
 Return编码：312-Return描述:NO_ROUTE
 交换机:weather_routing-路由key:china.hebei.shijiazhuang.20201128
 Return主题：中国河北石家庄20201128天气数据
 ===========================
 ===========================
 Return编码：312-Return描述:NO_ROUTE
 交换机:weather_routing-路由key:china.hubei.wuhan.20201128
 Return主题：中国湖北武汉20201128天气数据
 ===========================
 ===========================
 Return编码：312-Return描述:NO_ROUTE
 交换机:weather_routing-路由key:china.henan.zhengzhou.20201128
 Return主题：中国河南郑州20201128天气数据
 ===========================
 消息已被Broker接收,Tag:2
 消息已被Broker接收,Tag:3
 消息已被Broker接收,Tag:5
